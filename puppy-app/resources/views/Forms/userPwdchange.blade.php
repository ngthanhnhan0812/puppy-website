    ...
    <body>
        <div class="main-content">
            ...
            <div class="container-fluid mt--7">
                ...
                <div class="col-xl-6 order-xl-1 container">
                        ...
                        <div class="card-body">
                            ...
                            @if ($errors->any())
                                <div class="alert alert-danger alert-dismissible fade show container" role="alert">
                                    ...
                                    <span style="text-align: center;">{{$errors->first()}}</span>
                                </div>
                            @endif
                            <form method="POST"enctype="multipart/form-data">
                                @csrf
                                <h6 class="heading-small text-muted mb-4">User Change Password</h6>
                                <div class="pl-lg-4">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group focused">
                                                <label class="form-control-label" for="input-username">Current
                                                    Password</label>
                                                <input type="password" id="" name="changePwd"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="password" id="input-email" name="newPwd"
                                                    class="form-control form-control-alternative">
                                                @error('newPwd')
                                                    <p class="text-danger text-sm pl-lg-2">{{ $message }}</p>
                                                @enderror
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-email">Confirm Password
                                                </label>
                                                <input type="password" id="input-email" name="confirmnewPwd"
                                                    class="form-control form-control-alternative">
                                                @error('confirmnewPwd')
                                                    <p class="text-danger text-sm pl-lg-2">{{ $message }}</p>
                                                @enderror
